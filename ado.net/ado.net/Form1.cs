...
namespace ado.net
{
    public partial class Form1 : Form
    {
        ...
        //ProductDal' classýna baðlanmak için nesnesini oluþturduk.

        private void LoadProducts()
        {
            dgwProducts.DataSource = _productDal.GetAll();
            //Product' larý gösterecek datagridwiev' e DataSource komutuyla bilgileri çektik
        }
        ...
        {
            LoadProducts();
            //uygulama açýldýðýnda direk veritabaný göstermesini saðladýk
        }
